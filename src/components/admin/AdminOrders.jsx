...
export default function AdminOrders(){
   const {orders,deleteOrders,updateOrderStatus}= useAdmin()
            ...
            <div className="overflow-x-auto">
              ...
              <tbody>
                {localOrders.map((order) => (
                  ...
                  >
                     <td className="p-4 text-slate-100">{order.id}</td>
                    <td className="p-4 text-slate-200">{order.name}</td>
                    <td className="p-4 text-slate-100">${order.price}</td>
                    <td className="p-4 text-slate-100 text-center">{order.quantity}</td>
