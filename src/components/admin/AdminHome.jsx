...
// //   return (
// //     <div className="min-h-screen bg-gray-950 px-4 py-10 flex justify-center ml-15">
// //       <motion.div
...
// //       >
// //         <h1 className="text-5xl font-[Cinzel] tracking-[0.3em] text-slate-100 text-center mb-10">
// //           Dashboard Overview
// //         </h1>
...
// //             animate={{ opacity: 1, y: 0 }}
// //             className="bg-gray-900/80 backdrop-blur-xl border border-gray-800 rounded-2xl p-6 shadow-[0_0_40px_rgba(255,255,255,0.05)] flex flex-col items-center justify-center"
// //           >
// //             <h2 className="text-lg font-semibold text-slate-200 mb-2">Total Products</h2>
// //             <p className="text-4xl text-slate-100 font-bold">{products.length}</p>
// //           </motion.div>
...
// //             className="bg-gray-900/80 backdrop-blur-xl border border-gray-800 rounded-2xl p-6 shadow-[0_0_40px_rgba(255,255,255,0.05)] flex flex-col items-center justify-center"
// //           >
// //             <h2 className="text-lg font-semibold text-slate-200 mb-2">Total Users</h2>
// //             <p className="text-4xl text-slate-100 font-bold">{users.length}</p>
// //           </motion.div>
...
// //             className="bg-gray-900/80 backdrop-blur-xl border border-gray-800 rounded-2xl p-6 shadow-[0_0_40px_rgba(255,255,255,0.05)] flex flex-col items-center justify-center"
// //           >
// //             <h2 className="text-lg font-semibold text-slate-200 mb-2">Total Orders</h2>
...
//         className="bg-gray-900/80 backdrop-blur-xl border border-gray-800 rounded-2xl p-8 w-full max-w-5xl shadow-[0_0_40px_rgba(255,255,255,0.05)]"
//       >
    ...
    <div className="min-h-screen bg-gray-950 px-4 py-10 flex flex-col items-center space-y-10">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          <div className="bg-gray-800/70 border border-gray-700 p-6 rounded-xl text-center">
            <h2 className="text-lg font-semibold text-slate-200">Products</h2>
            <p className="text-3xl font-bold text-slate-100">{products.length}</p>
          </div>
          ...
          <div className="bg-gray-800/70 border border-gray-700 p-6 rounded-xl text-center">
            <h2 className="text-lg font-semibold text-slate-200">Orders</h2>
            <p className="text-3xl font-bold text-slate-100">{orders?.length || 0}</p>
          </div>
        </div>
